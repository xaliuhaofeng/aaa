...
{
    public partial class Cut_curve : UserControl
    {
       int ceDianId = 0;
        ...
        public void FillDataGrid(int index)
        {
            ...
            this.dataGridView1.Rows[0].Cells[1].Value = this.duanDianZhi;
            ...
            this.dataGridView1.Rows[0].Cells[10].Value = "复电";
            ...
            if (DataCurve.TimeStamps != null)
            {
                if (DataCurve.TimeStamps.Length > 0)
                {
                    if (DataCurve.CurveData[index] != Chart.NoValue)
                    {
                        ...
                        this.dataGridView1.Rows[0].Cells[10].Value = "断电";
                    }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            DataTable CurDataDt = CurveData.GetHisTableCut(startTime, endTime, ceDianBianHao, ceDianId);
            if (CurDataDt != null)
            {
                CurveData.GetHisCurveCut(CurDataDt, startTime, endTime,ceDianId, ref DataCurve, ref ZuiDaZhiCurve, ref ZuiXiaoZhiCurve, ref PingJunZhiCurve,ref alarmInfoList);
        ...
        private void Call_curve_Load(object sender, EventArgs e)
        {
            ...
            this.uC_Curve1.BaoJingMenXian.IsShow = Convert.ToBoolean(cConf.get("duanDianShowBaoJingMenXian"));
            ...
            this.uC_Curve1.DuanDianMenXian.IsShow = Convert.ToBoolean(cConf.get("duanDianShowDuanDianMenXian"));
            ...
            this.uC_Curve1.FuDianMenXian.IsShow = Convert.ToBoolean(cConf.get("duanDianShowFuDianMenXian"));
            ...
            DataCurve.IsShow = Convert.ToBoolean(cConf.get("duanDianShowBaoJingCurve"));
            DataCurve.CurveColor = ColorTranslator.FromHtml(cConf.get("moNiLiangColor"));
            DataCurve.CurveTitle = "断电曲线";
            this.checkBox4.Checked = DataCurve.IsShow;

            ZuiDaZhiCurve.IsShow = Convert.ToBoolean(cConf.get("duanDianShowZuiDaZhiCurve"));
            ...
            ZuiXiaoZhiCurve.IsShow = Convert.ToBoolean(cConf.get("duanDianShowZuiXiaoZhiCurve"));
            ...
            PingJunZhiCurve.IsShow = Convert.ToBoolean(cConf.get("duanDianShowPingJunZhiCurve"));
        ...
        private void checkBox1_CheckedChanged(object sender, EventArgs e)
        {
            ...
            cConf.set("duanDianShowBaoJingMenXian", this.checkBox1.Checked.ToString());
        ...
        private void checkBox2_CheckedChanged(object sender, EventArgs e)
        {
            ...
            cConf.set("duanDianShowDuanDianMenXian", this.checkBox2.Checked.ToString());
            if (this.uC_Curve1.timeStamps != null)
                this.uC_Curve1.UpdateDisplay();
        }
        ...
        private void checkBox3_CheckedChanged(object sender, EventArgs e)
        {
            ...
            cConf.set("duanDianShowFuDianMenXian", this.checkBox3.Checked.ToString());
            if (this.uC_Curve1.timeStamps != null)
                this.uC_Curve1.UpdateDisplay();
        }
        private void checkBox4_CheckedChanged(object sender, EventArgs e)
        {
            ...
            cConf.set("duanDianShowBaoJingCurve", this.checkBox4.Checked.ToString());
            if (this.uC_Curve1.timeStamps != null)
                this.uC_Curve1.UpdateDisplay();
        }
        private void checkBox5_CheckedChanged(object sender, EventArgs e)//是否显示最大值
        {
            ...
            cConf.set("duanDianShowZuiDaZhiCurve", this.checkBox5.Checked.ToString());
            if (this.uC_Curve1.timeStamps != null)
                this.uC_Curve1.UpdateDisplay();
        }     
        ...
        private void checkBox6_CheckedChanged(object sender, EventArgs e)
        {
            ...
            cConf.set("duanDianShowZuiXiaoZhiCurve", this.checkBox6.Checked.ToString());
            if (this.uC_Curve1.timeStamps != null)
                this.uC_Curve1.UpdateDisplay();
        }
        ...
        private void checkBox7_CheckedChanged(object sender, EventArgs e)
        {
            ...
            cConf.set("duanDianShowPingJunZhiCurve", this.checkBox7.Checked.ToString());
            if (this.uC_Curve1.timeStamps != null)
                this.uC_Curve1.UpdateDisplay();
        }

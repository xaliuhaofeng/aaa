namespace MAX_CMSS_V2
{
    ...
    public class Print_SheBeiGuZhang : UserControl
    {
        ...
        private BindingSource SheBeiGuZhangBindingSource;

        public Print_SheBeiGuZhang()
        {
        ...
        private void InitializeComponent()
        {
            ...
            this.SheBeiGuZhangBindingSource = new BindingSource(this.components);
            ...
            ((ISupportInitialize) this.SheBeiGuZhangBindingSource).BeginInit();
            this.max_cmssDataSet.BeginInit();
            base.SuspendLayout();
            this.SheBeiGuZhangBindingSource.DataMember = "SheBeiGuZhang";
            this.SheBeiGuZhangBindingSource.DataSource = this.max_cmssDataSet;
            ...
            reportDataSource1.Name = "max_cmssDataSet_SheBeiGuZhang";
            reportDataSource1.Value = this.SheBeiGuZhangBindingSource;
            this.reportViewer1.LocalReport.DataSources.Add(reportDataSource1);
            this.reportViewer1.LocalReport.ReportEmbeddedResource = "MAX_CMSS_V2.SheBeiGuZhang.rdlc";
            this.reportViewer1.Location = new Point(3, 30);
            this.reportViewer1.Name = "reportViewer1";
            this.reportViewer1.Size = new Size(0x3c1, 0x1f2);
            ...
            base.Name = "Print_SheBeiGuZhang";
            base.Size = new Size(0x3c7, 530);
            ((ISupportInitialize) this.SheBeiGuZhangBindingSource).EndInit();
        ...
        private void setReportDataSourceAndParam(DateTime date)
        {
            ...
            Logic.max_cmssDataSet.SheBeiGuZhangDataTable dt = ReportDataSuply.GetSheBeiGuZhangData(date);
            this.reportViewer1.LocalReport.DataSources.Clear();
            this.reportViewer1.LocalReport.DataSources.Add(new Microsoft.Reporting.WinForms.ReportDataSource("max_cmssDataSet_SheBeiGuZhang", dt));
        }
        ...
        private void setReportParam(DateTime date)
        {
            ...
            ReportParameter param2 = new ReportParameter("endTime", date.ToString("yyyy年MM月dd日") + " 23:59:59");
            list.Add(param2);
            ReportConfig config = ReportConfig.getConfigByName(8);

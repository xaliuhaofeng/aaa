namespace MAX_CMSS_V2
{
    ...
    public class Print_DKuiDian : UserControl
    {
        private Button button1;
        private Button button2;
        private IContainer components = null;
        private DateTimePicker dateTimePicker1;
        private BindingSource DKuiDianBindingSource;
        private Label label1;
        private Logic.max_cmssDataSet max_cmssDataSet;
        private ReportViewer reportViewer1;
        private SaveFileDialog saveFileDialog1;

        public Print_DKuiDian()
        {
        ...
        private void InitializeComponent()
        {
            ...
            this.DKuiDianBindingSource = new BindingSource(this.components);
            ...
            ((ISupportInitialize) this.DKuiDianBindingSource).BeginInit();
            this.max_cmssDataSet.BeginInit();
            base.SuspendLayout();
            this.DKuiDianBindingSource.DataMember = "DKuiDian";
            this.DKuiDianBindingSource.DataSource = this.max_cmssDataSet;
            ...
            reportDataSource1.Name = "max_cmssDataSet_DKuiDian";
            reportDataSource1.Value = this.DKuiDianBindingSource;
            this.reportViewer1.LocalReport.DataSources.Add(reportDataSource1);
            this.reportViewer1.LocalReport.ReportEmbeddedResource = "MAX_CMSS_V2.KaiGuanLiangKuiDian.rdlc";
            this.reportViewer1.Location = new Point(3, 30);
            this.reportViewer1.Name = "reportViewer1";
            this.reportViewer1.Size = new Size(0x3f1, 0x1f8);
            ...
            base.Name = "Print_DKuiDian";
            base.Size = new Size(0x3f1, 0x218);
            ((ISupportInitialize) this.DKuiDianBindingSource).EndInit();
        ...
        private void setReportDataSourceAndParam(DateTime date)
        {
            ...
            Logic.max_cmssDataSet.DKuiDianDataTable dt = ReportDataSuply.GetDKuiDianData(date);
            this.reportViewer1.LocalReport.DataSources.Clear();
            this.reportViewer1.LocalReport.DataSources.Add(new Microsoft.Reporting.WinForms.ReportDataSource("max_cmssDataSet_DKuiDian", dt));
        }
        ...
        private void setReportParam(DateTime date)
        {
            ...
            ReportParameter param2 = new ReportParameter("endTime", date.ToString("yyyy年MM月dd日") + " 23:59:59");
            list.Add(param2);
            ReportConfig config = ReportConfig.getConfigByName(6);

namespace MAX_CMSS_V2
{
    ...
    public class Print_DBaoJing : UserControl
    {
        private Button button1;
        private Button button2;
        private IContainer components = null;
        private DateTimePicker dateTimePicker1;
        private BindingSource DBaoJingBindingSource;
        private Label label1;
        private Logic.max_cmssDataSet max_cmssDataSet;
        private ReportViewer reportViewer1;
        private SaveFileDialog saveFileDialog1;

        public Print_DBaoJing()
        {
        ...
        private void InitializeComponent()
        {
            ...
            this.DBaoJingBindingSource = new BindingSource(this.components);
            ...
            ((ISupportInitialize) this.DBaoJingBindingSource).BeginInit();
            this.max_cmssDataSet.BeginInit();
            base.SuspendLayout();
            this.DBaoJingBindingSource.DataMember = "DBaoJing";
            this.DBaoJingBindingSource.DataSource = this.max_cmssDataSet;
            ...
            reportDataSource1.Name = "max_cmssDataSet_DBaoJing";
            reportDataSource1.Value = this.DBaoJingBindingSource;
            this.reportViewer1.LocalReport.DataSources.Add(reportDataSource1);
            this.reportViewer1.LocalReport.ReportEmbeddedResource = "MAX_CMSS_V2.KaiGuanLiangBaoJing.rdlc";
            this.reportViewer1.Location = new Point(3, 30);
            this.reportViewer1.Name = "reportViewer1";
            this.reportViewer1.Size = new Size(0x3e7, 0x1e3);
            ...
            base.Name = "Print_DBaoJing";
            base.Size = new Size(0x3ed, 0x206);
            ((ISupportInitialize) this.DBaoJingBindingSource).EndInit();
        ...
        private void setReportDataSourceAndParam(DateTime date)
        {
            ...
            Logic.max_cmssDataSet.DBaoJingDataTable dt = ReportDataSuply.GetDBaoJingData(date);
            this.reportViewer1.LocalReport.DataSources.Clear();
            this.reportViewer1.LocalReport.DataSources.Add(new Microsoft.Reporting.WinForms.ReportDataSource("max_cmssDataSet_DBaoJing", dt));
        }
        ...
        private void setReportParam(DateTime date)
        {
            ...
            ReportParameter param2 = new ReportParameter("endTime", date.ToString("yyyy年MM月dd日") + " 23:59:59");
            list.Add(param2);
            ReportConfig config = ReportConfig.getConfigByName(5);

namespace MAX_CMSS_V2
{
    ...
    public class Print_ADuanDian : UserControl
    {
        private BindingSource ADuanDianBindingSource;
        ...
        private void InitializeComponent()
        {
            ...
            this.ADuanDianBindingSource = new BindingSource(this.components);
            ...
            ((ISupportInitialize) this.ADuanDianBindingSource).BeginInit();
            this.max_cmssDataSet.BeginInit();
            base.SuspendLayout();
            this.ADuanDianBindingSource.DataMember = "ADuanDian";
            this.ADuanDianBindingSource.DataSource = this.max_cmssDataSet;
            ...
            reportDataSource1.Name = "max_cmssDataSet_ADuanDian";
            reportDataSource1.Value = this.ADuanDianBindingSource;
            this.reportViewer1.LocalReport.DataSources.Add(reportDataSource1);
            this.reportViewer1.LocalReport.ReportEmbeddedResource = "MAX_CMSS_V2.MoNiLiangDuanDian.rdlc";
            this.reportViewer1.Location = new Point(3, 30);
            this.reportViewer1.Name = "reportViewer1";
            this.reportViewer1.Size = new Size(0x400, 0x202);
            ...
            base.Name = "Print_ADuanDian";
            base.Size = new Size(0x414, 0x218);
            ((ISupportInitialize) this.ADuanDianBindingSource).EndInit();
        ...
        private void setReportDataSource(DateTime date)
        {
            ...
            Logic.max_cmssDataSet.ADuanDianDataTable dt = ReportDataSuply.GetADuanDianData(date);
            this.reportViewer1.LocalReport.DataSources.Clear();
            this.reportViewer1.LocalReport.DataSources.Add(new Microsoft.Reporting.WinForms.ReportDataSource("max_cmssDataSet_ADuanDian", dt));
        }
        ...
        private void setReportParam(DateTime date)
        {
            ...
            ReportParameter param2 = new ReportParameter("endTime", date.ToString("yyyy年MM月dd日") + " 23:59:59");
            list.Add(param2);
            ReportConfig config = ReportConfig.getConfigByName(2);

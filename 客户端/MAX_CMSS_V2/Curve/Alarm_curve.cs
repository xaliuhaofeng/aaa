...
{
    public partial class Alarm_curve : UserControl
    {
        int ceDianId = 0;
        ...
        public void FillDataGrid(int index)
        {
            ...
            this.dataGridView1.Rows[0].Cells[10].Value = "解警";
        ...
        private void OnClick()
        {
            ...
            DataTable CurDataDt = CurveData.GetHisTableAlarm(startTime, endTime, ceDianBianHao, ceDianId);
            if (CurDataDt != null)
            {
                CurveData.GetHisCurveAlarm(CurDataDt, startTime, endTime,ceDianId, ref DataCurve, ref ZuiDaZhiCurve, ref ZuiXiaoZhiCurve, ref PingJunZhiCurve, ref alarmInfoList);
        ...
        private void Call_curve_Load(object sender, EventArgs e)
        {
            ...
            this.uC_Curve1.BaoJingMenXian.IsShow = Convert.ToBoolean(cConf.get("alarmShowBaoJingMenXian"));
            ...
            this.uC_Curve1.DuanDianMenXian.IsShow = Convert.ToBoolean(cConf.get("alarmShowDuanDianMenXian"));
            ...
            this.uC_Curve1.FuDianMenXian.IsShow = Convert.ToBoolean(cConf.get("alarmShowFuDianMenXian"));
            ...
            DataCurve.IsShow = Convert.ToBoolean(cConf.get("alarmShowBaoJingCurve"));
            DataCurve.CurveColor = ColorTranslator.FromHtml(cConf.get("moNiLiangColor"));
            DataCurve.CurveTitle = "报警曲线";
            this.checkBox4.Checked = DataCurve.IsShow;

            ZuiDaZhiCurve.IsShow = Convert.ToBoolean(cConf.get("alarmShowZuiDaZhiCurve"));
            ...
            ZuiXiaoZhiCurve.IsShow = Convert.ToBoolean(cConf.get("alarmShowZuiXiaoZhiCurve"));
            ...
            PingJunZhiCurve.IsShow = Convert.ToBoolean(cConf.get("alarmShowPingJunZhiCurve"));
        ...
        private void checkBox1_CheckedChanged(object sender, EventArgs e)
        {
            ...
            cConf.set("alarmShowBaoJingMenXian", this.checkBox1.Checked.ToString());
        ...
        private void checkBox2_CheckedChanged(object sender, EventArgs e)
        {
            ...
            cConf.set("alarmShowDuanDianMenXian", this.checkBox2.Checked.ToString());
            if (this.uC_Curve1.timeStamps != null)
                this.uC_Curve1.UpdateDisplay();
        }
        ...
        private void checkBox3_CheckedChanged(object sender, EventArgs e)
        {
            ...
            cConf.set("alarmShowFuDianMenXian", this.checkBox3.Checked.ToString());
            if (this.uC_Curve1.timeStamps != null)
                this.uC_Curve1.UpdateDisplay();
        }
        private void checkBox4_CheckedChanged(object sender, EventArgs e)
        {
            ...
            cConf.set("alarmShowBaoJingCurve", this.checkBox4.Checked.ToString());
            if (this.uC_Curve1.timeStamps != null)
                this.uC_Curve1.UpdateDisplay();
        }
        private void checkBox5_CheckedChanged(object sender, EventArgs e)//是否显示最大值
        {
            ...
            cConf.set("alarmShowZuiDaZhiCurve", this.checkBox5.Checked.ToString());
            if (this.uC_Curve1.timeStamps != null)
                this.uC_Curve1.UpdateDisplay();
        }
        ...
        private void checkBox6_CheckedChanged(object sender, EventArgs e)
        {
            ...
            cConf.set("alarmShowZuiXiaoZhiCurve", this.checkBox6.Checked.ToString());
            if (this.uC_Curve1.timeStamps != null)
                this.uC_Curve1.UpdateDisplay();
        }
        ...
        private void checkBox7_CheckedChanged(object sender, EventArgs e)
        {
            ...
            cConf.set("alarmShowPingJunZhiCurve", this.checkBox7.Checked.ToString());
            if (this.uC_Curve1.timeStamps != null)
                this.uC_Curve1.UpdateDisplay();
        }

namespace MAX_CMSS_V2
{
    ...
    public class Print_AKuiDian : UserControl
    {
        private BindingSource AKuiDianBindingSource;
        ...
        private void InitializeComponent()
        {
            ...
            this.AKuiDianBindingSource = new BindingSource(this.components);
            ...
            ((ISupportInitialize) this.AKuiDianBindingSource).BeginInit();
            this.max_cmssDataSet.BeginInit();
            base.SuspendLayout();
            this.AKuiDianBindingSource.DataMember = "AKuiDian";
            this.AKuiDianBindingSource.DataSource = this.max_cmssDataSet;
            ...
            reportDataSource1.Name = "max_cmssDataSet_AKuiDian";
            reportDataSource1.Value = this.AKuiDianBindingSource;
            this.reportViewer1.LocalReport.DataSources.Add(reportDataSource1);
            this.reportViewer1.LocalReport.ReportEmbeddedResource = "MAX_CMSS_V2.MoNiLiangKuiDian.rdlc";
            this.reportViewer1.Location = new Point(3, 30);
            this.reportViewer1.Name = "reportViewer1";
            this.reportViewer1.Size = new Size(0x3eb, 0x1e5);
            ...
            base.Name = "Print_AKuiDian";
            base.Size = new Size(0x3ee, 0x207);
            ((ISupportInitialize) this.AKuiDianBindingSource).EndInit();
        ...
        private void setReportDataSourceAndParam(DateTime date)
        {
            ...
            Logic.max_cmssDataSet.AKuiDianDataTable dt = ReportDataSuply.GetAKuiDianData(date);
        ...
        private void setReportParam(DateTime date)
        {
            ...
            ReportParameter param2 = new ReportParameter("endTime", date.ToString("yyyy年MM月dd日") + " 23:59:59");
            list.Add(param2);
            ReportConfig config = ReportConfig.getConfigByName(3);

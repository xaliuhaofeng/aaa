namespace MAX_CMSS_V2
{
    ...
    public class Print_ABaoJing : UserControl
    {
        private BindingSource ABaoJingBindingSource;
        ...
        private void InitializeComponent()
        {
            ...
            this.ABaoJingBindingSource = new BindingSource(this.components);
            ...
            ((ISupportInitialize) this.ABaoJingBindingSource).BeginInit();
            this.max_cmssDataSet.BeginInit();
            base.SuspendLayout();
            this.ABaoJingBindingSource.DataMember = "ABaoJing";
            this.ABaoJingBindingSource.DataSource = this.max_cmssDataSet;
            ...
            reportDataSource1.Name = "max_cmssDataSet_ABaoJing";
            reportDataSource1.Value = this.ABaoJingBindingSource;
            this.reportViewer1.LocalReport.DataSources.Add(reportDataSource1);
            this.reportViewer1.LocalReport.ReportEmbeddedResource = "MAX_CMSS_V2.MoNiLiangBaoJing.rdlc";
            this.reportViewer1.Location = new Point(3, 30);
            this.reportViewer1.Name = "reportViewer1";
            this.reportViewer1.Size = new Size(0x406, 0x19b);
            ...
            base.Name = "Print_ABaoJing";
            base.Size = new Size(0x409, 0x1be);
            ((ISupportInitialize) this.ABaoJingBindingSource).EndInit();
        ...
        private void setReportDataSource(DateTime date)
        {
            ...
            Logic.max_cmssDataSet.ABaoJingDataTable dt = ReportDataSuply.GetABaoJingData(date);
            this.reportViewer1.LocalReport.DataSources.Clear();
            this.reportViewer1.LocalReport.DataSources.Add(new Microsoft.Reporting.WinForms.ReportDataSource("max_cmssDataSet_ABaoJing", dt));
            this.reportViewer1.RefreshReport();
        }
        ...
        private void setReportParam(DateTime date)
        {
            ...
            ReportParameter param2 = new ReportParameter("endTime", date.ToString("yyyy年MM月dd日") + " 23:59:59");
            list.Add(param2);
            ReportConfig config = ReportConfig.getConfigByName(1);
